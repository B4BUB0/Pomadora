  ...
  return (
    <div className={`min-h-screen transition-colors duration-500 ${
      darkMode 
        ...
        : 'bg-linear-to-br from-slate-50 via-indigo-50/30 to-slate-100'
    }`}>
          ...
          {!focusMode && (
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-extralight text-slate-800 dark:text-slate-100 mb-4 tracking-tight">
                Focus on What{' '}
                <span className="font-normal bg-linear-to-r from-indigo-500 to-violet-500 bg-clip-text text-transparent">
                  Matters
                </span>
              </h1>
